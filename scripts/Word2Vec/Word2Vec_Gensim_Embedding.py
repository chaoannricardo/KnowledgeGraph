...
if __name__ == '__main__':
    # configurations
    MODEL_SAVING_PATH = "../../models/210415_gensim_CBOW.model"
    ...
    model = word2vec.Word2Vec(sentences=sentences, corpus_file=None, vector_size=1000, alpha=0.025,
                              ...
                              cbow_mean=1, epochs=1000, null_word=0, trim_rule=None, sorted_vocab=1,
